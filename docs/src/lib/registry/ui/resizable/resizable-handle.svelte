...
>
	{#if withHandle}
		<div
			class="z-10 flex h-5 w-3 items-center justify-center rounded-sm bg-(--bg-elevated) ring-1 ring-(--text)/24"
		>
			<Icon
