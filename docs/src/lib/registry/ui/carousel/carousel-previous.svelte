...
<Button
	...
	class={cn(
		'lily-carousel-previous-1 absolute touch-manipulation rounded-full',
...
>
	<Icon
		...
		class={cn('lily-carousel-previous-2 size-4')}
		aria-hidden="true"
	/>
	<span class={cn('lily-carousel-previous-3 sr-only')}>Previous slide</span>
</Button>
