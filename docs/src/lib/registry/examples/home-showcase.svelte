...
<section class="mx-auto w-full max-w-[88rem] px-4 sm:px-6 lg:px-8">
	...
	<div class="flex flex-col items-center gap-6 pt-20 pb-14 text-center sm:pt-28 sm:pb-20">
		...
		<p class="max-w-2xl text-base leading-[1.6] tracking-[-0.48px] text-(--text)/56 sm:text-lg">
			A calm, rounded Svelte 5 component library — named design styles, installed by CLI and yours
			to own.
		</p>
		<div class="flex flex-wrap items-center justify-center gap-3 pt-2">
			<Button href="/docs" target="_parent">Get Started</Button>
			<Button href="/docs/components" target="_parent" variant="ghost">Browse Components</Button>
		</div>
	</div>
	...
	<div
		class={cn(
			'lily-home-grid columns-1 gap-4 pb-24 sm:columns-2 lg:columns-3 xl:columns-4 [&>*]:mb-4 [&>*]:break-inside-avoid'
		)}
	>
		<!-- Composition: sign in -->
		<Card>
			<CardHeader>
				...
				<CardDescription>Email and password fields.</CardDescription>
			</CardHeader>
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>Action weights and sizes.</CardDescription>
			</CardHeader>
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>Compact status labels.</CardDescription>
			</CardHeader>
		...
		<Card>
			...
			<CardContent>
				<Calendar type="single" bind:value={calValue} class={cn(' lily-home-calendar')} />
			</CardContent>
		</Card>
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>Navigation between related views.</CardDescription>
			</CardHeader>
			<CardContent>
				<Tabs value="overview">
					<TabsList>
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>Choose a text alignment.</CardDescription>
			</CardHeader>
			<CardContent>
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>Structured records.</CardDescription>
			</CardHeader>
			<CardContent>
				<Table.Root>
					<Table.Header>
		...
		<Card>
			...
			<CardContent>
				<Breadcrumb>
					<BreadcrumbList>
						<BreadcrumbItem>
							<BreadcrumbLink href="/" target="_parent">Home</BreadcrumbLink>
						</BreadcrumbItem>
						<BreadcrumbSeparator />
						<BreadcrumbItem>
							<BreadcrumbLink href="/docs" target="_parent">Docs</BreadcrumbLink>
						</BreadcrumbItem>
						<BreadcrumbSeparator />
						<BreadcrumbItem>
