...
<div class="mx-auto flex w-full max-w-6xl flex-1 gap-10 px-5">
	<aside
		class="sticky top-14 hidden h-[calc(100svh-3.5rem)] w-56 shrink-0 overflow-y-auto py-10 md:block"
	>
