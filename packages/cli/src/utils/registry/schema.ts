...
export const componentsJsonSchema = z.object({
	...
	registry: z
		...
		.optional()
		.describe(
			"The registry URL tells the CLI where to fetch the lily components/registry from. You can pin this to a specific preview release or your own fork of the registry."
		),
	typescript: z
		.union([
			z.boolean(),
